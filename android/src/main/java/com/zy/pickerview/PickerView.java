...
public class PickerView extends android.support.v7.widget.AppCompatSpinner {
  ...
  public PickerView(Context context, int mode) {
    super(context, mode);
    mMode = mode;
  }
  ...
  public PickerView(Context context, AttributeSet attrs, int defStyle, int mode) {
